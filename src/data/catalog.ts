...
export const STYLES: Style[] = [
  ...
  { id: "school-uniform", name: "School uniform", category: "uniforms", description: "Shirt with shorts or trousers in your school's colours. Priced per pupil, with bulk rates for schools.", fromPrice: 150, studioFabricFrom: 80, readyDays: 10, featured: true, tone: "sky" },
  { id: "staff-uniform", name: "Staff & group uniform", category: "uniforms", description: "Matching shirts, kaftans or suits for your company, choir or association.", fromPrice: 350, studioFabricFrom: 150, readyDays: 14, tone: "steel" },
